...
function heroSection() {
	...
	$('.hero-item').each(function() {
		...
		$(this).css({
			...
			'webkit-box-shadow': 'inset 0px 0px 149px 5px rgba(0,0,0,0.75)',
			'-moz-box-shadow': 'inset 0px 0px 149px 5px rgba(0,0,0,0.75)',
			'box-shadow': 'inset 0px 0px 149px 5px rgba(0,0,0,0.75)',
...
function fornecedores() {
	// testimonial Carousel 
	$('#fornecedores-slide').owlCarousel({
		loop:true,
		autoplay:true,
		margin:30,
		nav:false,
